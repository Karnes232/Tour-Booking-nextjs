      ...
      >
        <div className="aboutDiv">
          ...
          <p className="aboutParagraph">
            ...
            maiores, fugit molestiae laborum quae id commodi vero accusantium
            laboriosam corrupti nihil eligendi quasi officiis.
          </p>
        </div>
        <div className="aboutDiv">
          ...
          <p className="aboutParagraph">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia
            maiores, fugit molestiae laborum quae id commodi vero accusantium
            laboriosam corrupti nihil eligendi quasi officiis dafda.
          </p>
        </div>
        ...
        <div className="aboutDiv">
          ...
          <p className="aboutParagraph">
            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia
            maiores, fugit molestiae laborum quae id commodi{' '}
          </p>
        </div>
      </Carousel>
    </div>
